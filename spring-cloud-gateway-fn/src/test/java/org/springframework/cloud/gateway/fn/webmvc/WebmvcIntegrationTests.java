...
import static org.springframework.cloud.gateway.fn.webmvc.FilterFunctions.addRequestHeader;
import static org.springframework.cloud.gateway.fn.webmvc.HandlerFunctions.http;
import static org.springframework.web.servlet.function.RequestPredicates.GET;
import static org.springframework.web.servlet.function.RouterFunctions.route;

@SpringBootTest(properties = "logging.level.reactor.netty.http.client=TRACE",
...
public class WebmvcIntegrationTests {
	...
	protected static class TestConfiguration {
		...
		@Bean
		public RouterFunction<ServerResponse> routerFunctions(TestHandler testHandler) {
